...
<br>
        ...
        <div class="form-group">
            ...
            <input id="shipper_name" class="form-control" type="text" name="shipper_name" value="{{ old('shipper_name') }}" required autofocus autocomplete="shipper_name" />
...
<br>
        ...
        <div class="form-group">
            ...
            <input id="shipper_email" class="form-control" type="email" name="shipper_email" value="{{ old('shipper_email') }}" required autocomplete="shipper_email" />
...
<br>
        ...
        <div class="form-group">
            ...
            <input id="shipper_address" class="form-control" type="text" name="shipper_address" value="{{ old('shipper_address') }}" required autocomplete="shipper_address" />
...
<br>
 ...
 <div class="form-group">
    ...
    <input id="receiver_name" class="form-control" type="text" name="receiver_name" value="{{ old('receiver_name') }}" required autofocus autocomplete="receiver_name" />
...
<div class="form-group">
    ...
    <input id="receiver_email" class="form-control" type="email" name="receiver_email" value="{{ old('receiver_email') }}" required autocomplete="receiver_email" />
...
<div class="form-group">
    ...
    <input id="receiver_address" class="form-control" type="text" name="receiver_address" value="{{ old('receiver_address') }}" required autocomplete="receiver_address" />
...
<div class="form-group">
    ...
    <input id="tracking_number" class="form-control" type="text" name="tracking_number" value="{{ old('tracking_number') }}" required autofocus autocomplete="tracking_number" maxlength="10" placeholder="nsdet345aw" />
...
<div class="form-group">
    ...
    <input id="origin" class="form-control" type="text" name="origin" value="{{ old('origin') }}" required autocomplete="origin" placeholder="enter the percel origin " />
...
<div class="form-group">
    ...
    <input id="destination" class="form-control" type="text" name="destination" value="{{ old('destination') }}" required autocomplete="destination" placeholder="enter the percel destination " />
...
<div class="form-group">
    ...
    <input id="weight" class="form-control" type="text" name="weight" value="{{ old('weight') }}" required autocomplete="weight" placeholder="10kg" />
...
<div class="form-group">
    ...
    <input id="freight_type" class="form-control" type="text" name="freight_type" value="{{ old('freight_type') }}" required autocomplete="freight_type" placeholder="" />
...
<div class="form-group">
    ...
    <input id="departure_date" class="form-control" type="date" name="departure_date" value="{{ old('departure_date') }}" required autocomplete="departure_date" />
...
<div class="form-group">
    ...
    <input id="package" class="form-control" type="text" name="package" value="{{ old('package') }}" required autocomplete="package" placeholder="" />
...
<div class="form-group">
    ...
    <input id="carrier" class="form-control" type="text" name="carrier" value="{{ old('carrier') }}" required autocomplete="carrier" placeholder="" />
...
<div class="form-group">
    ...
    <input id="shipment_mode" class="form-control" type="text" name="shipment_mode" value="{{ old('shipment_mode') }}" required autocomplete="shipment_mode" placeholder="" />
...
<div class="form-group">
    ...
    <input id="payment_mode" class="form-control" type="text" name="payment_mode" value="{{ old('payment_mode') }}" required autocomplete="payment_mode" placeholder="" />
...
<div class="form-group">
    ...
    <input id="type_of_shipment" class="form-control" type="text" name="type_of_shipment" value="{{ old('type_of_shipment') }}" required autofocus autocomplete="type_of_shipment" placeholder="" />
...
<div class="form-group">
    ...
    <input id="quantity" class="form-control" type="text" name="quantity" value="{{ old('quantity') }}" required autocomplete="quantity" placeholder="10 parcels" />
...
<div class="form-group">
    ...
    <input id="expected_delivery_date" class="form-control" type="date" name="expected_delivery_date" value="{{ old('expected_delivery_date') }}" required autofocus autocomplete="expected_delivery_date" />
...
<div class="form-group">
    ...
    <input id="pickup_date" class="form-control" type="date" name="pickup_date" value="{{ old('pickup_date') }}" required autofocus autocomplete="pickup_date" />
...
<div class="form-group">
    ...
    <input id="pickup_time" class="form-control" type="text" name="pickup_time" value="{{ old('pickup_time') }}" required autofocus autocomplete="pickup_time" />
...
<div class="form-group">
    ...
    <input id="status" class="form-control" type="text" name="status" value="{{ old('status') }}" required autocomplete="status" />
...
<div class="form-group">
    ...
    <input id="current_location" class="form-control" type="text" name="current_location" value="{{ old('current_location') }}" required autocomplete="current_location" />
...
<div class="form-group">
    ...
    <textarea name="comment"  placeholder="{{ __('comment about the status of the delivery') }}" required class="form-control" :value="{{ old('comment') }}"></textarea>
</div>
